...
export default function Sidebar() {
  ...
  return (
    <div className="text-gray w-full p-4 rounded-lg border border-solid flex flex-col">
      <div className="flex justify-between items-baseline border-b mb-4">
      ...
      <div className="p-5 mb-4 border-b">
        ...
        <label className="font-bold block mt-4 mb-1">Categoria</label>
      ...
      <div className="flex justify-center">
        <button onClick={apllyFilter} className="bg-black text-white px-8 py-2 rounded-full">
          Aplicar Filtro
        </button>
      </div>
    </div>
